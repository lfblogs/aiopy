...
from aiopy.required.aiohttp import errors, hdrs
from aiopy.required.aiohttp.log import ws_logger
...
if bool(os.environ.get('AIOHTTP_NO_EXTENSIONS')):
    ...
    try:
        from aiopy.require.aiohttp._websocket import _websocket_mask_cython
